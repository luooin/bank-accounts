        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '卡号' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.kaihuUuidNumber" placeholder="卡号"
                            clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '账户类型' : ''">
                        <el-select v-model="searchForm.kaihuTypes" placeholder="请选择账户类型">
                            ...
                            <el-option v-for="(item, index) in kaihuTypesSelectSearch" v-bind:key="index"
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        <el-button v-if="isAuth('kaihu', '新增')" type="success" icon="el-icon-plus"
                            @click="addOrUpdateHandler()">开户</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('kaihu', '删除')" :disabled="dataListSelections.length <= 0" type="danger"
                            icon="el-icon-delete" @click="deleteHandler()">删除</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('kaihu', '报表')" type="success" icon="el-icon-pie-chart"
                            @click="chartDialog()">报表</el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                            v-if="isAuth('kaihu', '导入导出')" icon="el-icon-download"
                            href="http://localhost:8080/bank/upload/kaihuMuBan.xls">批量导入账户信息数据模板</a>
                        &nbsp;
                        <el-upload v-if="isAuth('kaihu', '导入导出')" style="display: inline-block" action="bank/file/upload"
                            :on-success="kaihuUploadSuccess" :on-error="kaihuUploadError" :show-file-list=false>
                            <el-button v-if="isAuth('kaihu', '导入导出')" type="success"
                                icon="el-icon-upload2">批量导入账户信息数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('kaihu', '导入导出')" style="display: inline-block"
                            class="export-excel-wrapper" :data="dataList" :fields="json_fields" name="kaihu.xls">
                            <!-- 导出excel -->
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    v-if="isAuth('kaihu', '查看')" :data="dataList" v-loading="dataListLoading"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                        prop="kaihuUuidNumber" header-align="center" label="卡号">
                        <template slot-scope="scope">
                            {{ scope.row.kaihuUuidNumber }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="kaihuTypes"
                        header-align="center" label="账户类型">
                        <template slot-scope="scope">
                            {{ scope.row.kaihuValue }}
                        </template>
                    </el-table-column>

                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="kaihuMoney"
                        header-align="center" label="账户余额">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="insertTime"
                        header-align="center" label="开户时间">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign" header-align="center" label="操作">
                        <template slot-scope="scope">
                            <el-button v-if="isAuth('kaihu', '查看')" type="success" icon="el-icon-tickets" size="mini"
                                @click="addOrUpdateHandler(scope.row.id, 'info')">详情</el-button>
                            <el-button v-if="isAuth('kaihu', '修改')" type="primary" icon="el-icon-edit" size="mini"
                                @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                            <el-button v-if="isAuth('kaihu', '删除')" type="danger" icon="el-icon-delete" size="mini"
